...
const Navbar = () => {
  ...
  <div className="flex-1">
    <a className="btn btn-ghost gap-0 text-secondary normal-case font-bold text-2xl">Byte<span className="text-primary">Base</span></a>
  </div>
  <div className="flex-none">
    <ul className="menu menu-horizontal px-1">
      <li className="font-bold text-xl"><a>Home</a></li>
      <li className="text-secondary font-bold text-xl"><a>Blogs</a></li>
